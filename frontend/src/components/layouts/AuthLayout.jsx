...
import CARD_2 from '../../assets/images/card2-responsive.svg'
...
const AuthLayout = ({ children }) => {
    return (
        <div className='flex flex-col md:flex-row min-h-screen'>
            ...
            <div className='hidden md:block w-[48vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat overflow-hidden p-8 relative'>
